...
console.log(form);
var validateButton = document.querySelector('[data-button]');
console.log(validateButton);
var phone = document.querySelector('[data-tel]');
var customerName = document.querySelector('[data-user-name]');
...
var checkPhoneMatch = function checkPhoneMatch() {
  if (!reg.test(phone.value)) {
    var error = generateError('Не верный формат телефона');
